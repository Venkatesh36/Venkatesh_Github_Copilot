...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice teamwork, drills, and play against other schools",
        "schedule": "Mondays, Wednesdays, Fridays, 4:00 PM - 6:00 PM",
        "max_participants": 15,
        "participants": ["natalie@mergington.edu", "alex@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Develop swimming skills and prepare for aquatic meets",
    ...
    "Drama Club": {
        "description": "Practice acting, stage production, and perform school plays",
